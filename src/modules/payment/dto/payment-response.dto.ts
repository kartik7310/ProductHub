...
export class CreatePaymentIntentResponse {
    @ApiProperty({ example: 'pi_165465465', description: 'Stripe client secret for payment confirmation', })
    clientSecret: string;

    @ApiProperty({ example: '2165465-454-sds4s854d65', description: 'Payment ID in database', })
    paymentId: string;
}

export class PaymentResponseDto {
    @ApiProperty({ example: '1215645s454sdosd4s-454sd', })
    id: string;
